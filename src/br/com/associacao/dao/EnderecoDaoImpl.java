...
public class EnderecoDaoImpl implements Serializable {
    ...
    public void salvarEnderecoAluno(Endereco endereco, int idEstrangeiro, Connection conexao) throws SQLException {
    ...
    public void alterar(Endereco endereco, int idEstrangeiro, Connection conexao) throws SQLException {
        String sql = "UPDATE endereco SET logradouro = ?, numero = ?, bairro = ?, cidade = ?, estado = ?, complemento = ? WHERE idPessoa = ?";
